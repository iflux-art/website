...
export function InlineCode({
  ...
  return (
    <ProjectInlineCode className={className}>{children}</ProjectInlineCode>
  );
}
```
...
export function CodeBlock({
  ...
  return (
    <div className={cn("relative", className)}>
      ...
      <pre className="overflow-auto bg-zinc-50 p-4 dark:bg-zinc-900">
...
export const mdxComponents = {
  ...
  h1: ({ children, id, ...props }) => {
    ...
    return (
      <h1
        id={headingId}
        className={cn(headingStyles.h1, props.className)}
        {...props}
      >
        {children}
      </h1>
  ...
  h2: ({ children, id, ...props }) => {
    ...
    return (
      <h2
        id={headingId}
        className={cn(headingStyles.h2, props.className)}
        {...props}
      >
        {children}
      </h2>
        ...
        className={cn(
          ...
          // 条件样式
          {
            "border-yellow-200 bg-yellow-50 text-yellow-800":
              props.type === "warning",
            "border-red-200 bg-red-50 text-red-800": props.type === "error",
          },
          // 允许外部覆盖
          className,
        )}
