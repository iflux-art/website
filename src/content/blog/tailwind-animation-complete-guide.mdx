...
```html
<!-- 旋转动画 -->
<div class="animate-spin h-5 w-5 rounded-full border-2 border-gray-300 border-t-blue-600"></div>

<!-- 缩放淡出动画 -->
<span class="animate-ping absolute h-3 w-3 rounded-full bg-red-500 opacity-75"></span>

<!-- 淡入淡出动画 -->
<div class="animate-pulse bg-gray-200 rounded h-10 w-full"></div>

<!-- 弹跳动画 -->
<div class="animate-bounce w-10 h-10 bg-blue-500 rounded-full"></div>
```
...
```html
<button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded transition duration-300 transform active:scale-95">
  点击我
</button>
```
...
```html
<div class="transition duration-300 ease-in-out transform hover:-translate-y-1 hover:shadow-lg bg-white rounded-lg p-6">
