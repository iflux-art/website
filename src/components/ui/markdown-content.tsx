...
export function MarkdownContent({
  ...
  // 处理资源卡片 - 使用 MutationObserver 监视 DOM 变化
  useEffect(() => {
    ...
    const processCards = () => {
      ...
      try {
        ...
        if (resourceCardElements.length > 0) {
          console.log(`Processing ${resourceCardElements.length} resource cards`);
          ...
          resourceCardElements.forEach(element => {
            ...
            cardElement.innerHTML = `
              <div class="h-full overflow-hidden hover:shadow-lg transition-all border border-border rounded-lg ${
        ...
        console.error('Error processing resource cards:', error);
      }
    };
