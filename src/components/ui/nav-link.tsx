...
export function NavLink({
  ...
  currentDoc,
  className = '',
  activeClassName = 'bg-accent/50 text-foreground font-medium shadow-sm',
  inactiveClassName = 'text-muted-foreground hover:text-foreground hover:bg-accent/50 hover:shadow-sm',
  onClick,
  onMouseEnter,
  onMouseLeave,
  target,
  ...
  return (
    <Link
      href={href}
      className={cn(
        'flex items-center justify-between py-2 px-3 rounded-lg text-sm transition-all duration-200',
        className,
