// 从 @/lib/markdown 模块导入 BaseMdxFrontmatter 和 getAllChilds 方法
import { BaseMdxFrontmatter, getAllChilds } from "@/lib/markdown";
// 从 next/link 模块导入 Link 组件
...
/**
 * 子项卡片组件，用于显示子项的标题和描述，并提供链接
 * @param description - 子项的描述信息
 * @param href - 子项链接的目标地址
 * @param title - 子项的标题
 */
