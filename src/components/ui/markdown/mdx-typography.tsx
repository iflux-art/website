...
// 标题组件
export function MDXHeading1({ className, children }: TypographyProps) {
  return <h1 className={cn('text-4xl font-bold tracking-tight mt-8 mb-4 scroll-m-20', className)}>{children}</h1>;
}

export function MDXHeading2({ className, children }: TypographyProps) {
  return <h2 className={cn('text-2xl font-semibold tracking-tight mt-10 mb-4 pb-2 border-b scroll-m-20', className)}>{children}</h2>;
}

export function MDXHeading3({ className, children }: TypographyProps) {
  return <h3 className={cn('text-xl font-semibold tracking-tight mt-8 mb-3 scroll-m-20', className)}>{children}</h3>;
}

export function MDXHeading4({ className, children }: TypographyProps) {
  return <h4 className={cn('text-lg font-semibold tracking-tight mt-8 mb-3 scroll-m-20', className)}>{children}</h4>;
}
