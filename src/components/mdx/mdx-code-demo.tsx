...
export const MDXCodeDemo = ({
  ...
  return (
    <div
      ref={containerRef}
      className={`my-6 rounded-lg border border-gray-200 dark:border-gray-700 ${isFullscreen ? "fixed inset-0 z-50 bg-white dark:bg-gray-900" : ""} ${className} `}
    >
      {/* 头部工具栏 */}
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex overflow-hidden rounded-lg border border-gray-200 dark:border-gray-700">
            <button
              ...
              className={`flex items-center gap-1.5 p-1.5 text-xs font-medium ${
                view === "code"
          ...
          <button
            onClick={handleCopy}
            className="rounded-lg p-1.5 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200"
      ...
      {/* 内容区域 */}
      <div
        className={` ${view === "split" ? "grid grid-cols-2 divide-x divide-gray-200 dark:divide-gray-700" : ""} `}
      >
        {/* 代码区域 */}
        ...
        {(view === "preview" || view === "split") && (
          <div className="overflow-auto bg-gray-50 p-4 dark:bg-gray-800">
            {preview}
          </div>
        )}
      </div>
