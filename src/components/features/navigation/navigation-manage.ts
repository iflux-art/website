...
import { navigation } from '@/components/features/navigation/navigation-data';
import type { Category, Item } from '@/components/features/navigation/navigation-data';
import type { NavigationData } from '@/components/features/navigation/navigation-types';
/**
 * 确保数据目录存在
 */
