...
import { Home, AlertCircle, Search, ArrowLeft } from 'lucide-react';
...
export function NotFound({
  ...
  return (
    ...
    >
      <section aria-labelledby="error-title" className="w-full max-w-4xl">
        <div className="flex flex-col items-center space-y-8">
          ...
          <div className="mx-auto my-6 h-0.5 w-full max-w-md bg-muted" role="separator" />
