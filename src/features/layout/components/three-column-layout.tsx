...
import type { SidebarConfig } from '@/types/page-types';
import type { ThreeColumnLayoutProps } from '../types/page-container';
import { THREE_COLUMN_LAYOUT_CONFIG } from '../lib/page-container-utils';
