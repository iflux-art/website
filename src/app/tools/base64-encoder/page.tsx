...
export default function Base64EncoderPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-6 flex items-center gap-4">
        <div className="flex items-center gap-2">
          <Button
            ...
            className="flex items-center gap-2 rounded-md bg-primary px-4 py-2 text-primary-foreground hover:bg-primary/90 dark:bg-slate-700 dark:hover:bg-slate-600"
          >
        ...
        <Button
          onClick={switchMode}
          variant="outline"
          className="flex items-center gap-2 rounded-md bg-background px-4 py-2 hover:bg-accent dark:bg-slate-800 dark:text-slate-100 dark:hover:bg-slate-700"
        >
      ...
      {/* 使用说明 */}
      <Card className="mt-8 space-y-4 rounded-lg border bg-background p-4 dark:bg-slate-900">
        <CardHeader>
          <CardTitle>使用说明</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          <div>
            <h4 className="mb-2 font-medium">什么是 Base64？</h4>
          ...
          <div>
            <h4 className="mb-2 block text-sm font-medium text-gray-900 dark:text-gray-300">
              常见用途
            </h4>
